...
with open("C:/Users/vedan/OneDrive/Desktop/Mangakai/mangakai_backend/mangakai/character1.json", "r", encoding="utf-8") as f:
    prompt = json.load(f)
...
prompt["4"]["inputs"]["image"] = args.main_pose
prompt["2"]["inputs"]["text"] =  args.main_prompt
prompt["14"]["inputs"]["image"] = args.anime_image
